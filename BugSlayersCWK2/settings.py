"""
Django settings for BugSlayersCWK2 project.
...
SECRET_KEY = 'django-insecure-%vj%&3!hm1k^$7*99_bk(^w+y2e*b6&n2$a8m54k^btnr+jtg5'
...
ROOT_URLCONF = 'BugSlayersCWK2.urls'
...
WSGI_APPLICATION = 'BugSlayersCWK2.wsgi.application'
